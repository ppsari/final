...
class MyDetailProperty extends React.Component {
            ...
            <div className="ListViewProperty">
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  ? <h5>{prettyMoney(this.state.property.price.amount)}</h5>
                  : <h5>{prettyMoney(this.state.property.price)} / {this.state.property.price.descr}</h5>
                  }
                  <br />
                  <small>Address</small>
  ...
  componentWillMount(){
    ...
    if(propStatus === `rent`){
      ...
      .then(ps=>{
        // console.log(ps.data);
        // console.log(JSON.parse(ps.data.location.lng));
        this.setState({
          property: ps.data,
